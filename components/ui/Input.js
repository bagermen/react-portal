...
class Input extends Component {
  ...
  render() {
    ...
    let { errorMessage = "required", onFieldChange, classes, rounded, readOnly, ...rest } = this.props;
    return (
      <div className={`${classes}`}>
        <div className={`${classNames({"iconic-input": this.props.icon})}`}>
          {icon}
          <input
            type={format}
            autoComplete="off"
            className={`${classNames("form-control", {"rounded": rounded})}`}
